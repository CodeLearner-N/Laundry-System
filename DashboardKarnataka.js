...
const DashboardKarnataka = () => {
  ...
  useEffect(() => {
    if (selectedStatus === "pending") {
      axios
        .get("http://localhost:5000/api/payments/pending/karnataka")
        .then((response) => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex">
      ...
      <aside className="w-64 bg-gray-800 text-white p-4">
        <h2 className="text-xl font-bold mb-6">Karnataka Dashboard</h2>
        <nav>
      ...
      {view === "dashboard" && (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-2xl font-semibold text-gray-800 mb-6 text-center">
            Welcome to Karnataka Dashboard
          </h1>
        ...
        {isModalOpen && (
          <div className="fixed inset-0 flex items-center justify-center z-50">
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 z-10">
              ...
              <p>
                <strong>Branch:</strong> Karnataka
              </p>
...
export default DashboardKarnataka;
